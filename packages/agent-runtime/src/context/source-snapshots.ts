import { TrustEnvelopeService, type TrustClass, type TrustEnvelope } from "@verchestra/application";
...
export type ContextSourceKind = (typeof SOURCE_KINDS)[number];
...
export interface ContextFragmentInput {
  ...
  readonly classification: DataClassificationValue;
  readonly trust: (typeof TRUST_CLASSES)[number];
