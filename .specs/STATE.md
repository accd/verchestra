...
- **Programme:** `milestone-2-completion` — the tracked distribution of all 13 open issues across three workstreams (AD-013); see `.specs/features/milestone-2-completion/{analysis,spec,tasks,handoff}.md`. Next programme action: **B1 — MiguelCorre authors `docs/qualification/t72-validation.md`** and advances the chain atomically.
