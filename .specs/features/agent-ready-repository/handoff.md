...
nextTask: T2
lastGate: node --test apps/site/tests/unit/product-contract.test.mjs
updatedAt: 2026-07-25T22:56:00Z
---
...
Add root and scoped `AGENTS.md` files, the repository map, exact compatibility
pointers, and their contract tests.
