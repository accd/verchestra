...
| P4 | #16/T75: qualify one immutable candidate and advance the chain. | P1, P2, P3 | Five profiles on five targets, signed zero-contradiction index, independent verifier report, `t75-validation.md`, `gate:quick/full/build/security/release`, human-reviewed atomic status advance. |
