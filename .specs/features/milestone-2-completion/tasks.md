...
| C1   | **Done** — rebased onto current upstream/main and merged                                                                                                                                           | PR #209 (merged)                                  |
| C3   | **Done** — closure evidence recorded, issue closed                                                                                                                                                 | PR #250 (merged); #110 closed                     |
...
| C6   | **Done** — 7 ports published, exports declared, 6 kits parameterized, fixture-instrumentation unwelded, error mapping fixed, 7-engine parity guard, contract documented; #233 closed               | PR #252 (merged)                                  |
| C2   | In progress — T4a landed via C1; T4b–T4j (authority.ts through hermetic-bundle.ts/transactional-activation.ts) remain                                                                              | See PR #209                                       |
...
| C5   | Partial — the `.vestra`/`.verchestra` root-drift fix (accd's #207 comment) landed with a static anti-drift test; the seven live-probe upgrades remain blocked on A3's provisioned fixtures         | PR #251 (merged)                                  |
| A4   | Planned                                                                                                                                                                                            | Pending                                           |
| C4   | **Done** — independent report, 6/6 sensor, quick/build gates, atomic advance                                                                                                                       | PR #255 (report binds `23e78dc`; run 31525323571) |
| B2   | Blocked — repeat verification at `36fb77f` passes F1/F2 (8/8 sensor) but F3 proves five invalid candidate-controlled evidence sets promote; implementation-author remediation required before re-verification | `.specs/features/sealed-holdout/validation.md` |
| B3   | Planned                                                                                                                                                                                            | Pending                                           |
| A5   | Planned                                                                                                                                                                                            | Pending                                           |
| A6   | Planned                                                                                                                                                                                            | Pending                                           |
| A7   | Continuous                                                                                                                                                                                         | —                                                 |
