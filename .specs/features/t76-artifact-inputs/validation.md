...
| T76-INPUT-04 five-target reproducible execution | `tests/agent-readiness/t76-candidate-workflow.test.mjs` binds the supported fleet, exact revision/runtime, all five gates, portable artifacts, and exact collection | PASS   |
...
- `node --test tests/build/t76-candidate-materializer.test.mjs` — 3 passed, 0
  failed, skipped, or todo.
- `node --test tests/agent-readiness/t76-candidate-workflow.test.mjs` — 6
