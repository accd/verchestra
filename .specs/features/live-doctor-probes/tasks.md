...
| T2 | Existing-dependency live observers for sandbox, runtime SQLite, secret presence, and driver | LDP-03, LDP-05–LDP-07 | integration + security + `pnpm gate:security` | Complete |
