...
**Qualified packages:** `@earendil-works/pi-agent-core@0.84.1`, `@earendil-works/pi-ai@0.84.1`

## Qualification boundary

This report supersedes the package-version identity recorded by
`docs/qualification/pi-runtime-0.82.1.md` without changing the driver
...
- The real `PiDriver.probe()` resolves the installed package manifest and
  ...
  and any version other than `0.84.1` is unsupported.
