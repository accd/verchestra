...
const MATRIX_CEILINGS = Object.freeze({
  ...
  "packages/data-probe/src/sap-ase-adapter.ts": 2,
  "packages/data-probe/src/postgresql-adapter.ts": 2,
  "packages/data-probe/src/oracle-adapter.ts": 2,
  "packages/data-probe/src/mysql-family-adapter.ts": 2,
  "packages/data-probe/src/mongodb-adapter.ts": 1,
