...
test("keeps the qualified Pi runtime on one exact package version", () => {
  ...
  assert.equal(manifest.devDependencies["@earendil-works/pi-agent-core"], "0.84.2");
  ...
  assert.deepEqual([...packageVersions], ["@earendil-works/pi-agent-core@0.84.2", "@earendil-works/pi-ai@0.84.2"]);
});
